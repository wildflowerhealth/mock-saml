...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Attribute names mirror Sydney's outgoing SAML. Revise once Elevance's
  // Okta-side intake (SYS-17901) confirms its real attribute mapping.
